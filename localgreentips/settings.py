"""
Django settings for localgreentips project.
...
SECRET_KEY = ')+!*5ogqx*8c&qbx@kxq+@^%-0p4&(l_m#=-b%&rec&m^khw5q'
...
ROOT_URLCONF = 'localgreentips.urls'
...
WSGI_APPLICATION = 'localgreentips.wsgi.application'
